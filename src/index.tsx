    ...
    return (
      <Container>
        <Card title="">
          ...
          <CenteredRow>
            This application is a part of a project assignment in the course DCST1008, from the program Digital Infrastructure and Cybersecurity at NTNU Trondheim.
            Contributing members are Håkon Skaufel, Fabian Sandvik, Ola Sagberg and Tord Valestrand.
          </CenteredRow>
        </Card>
      </Container>
    )
